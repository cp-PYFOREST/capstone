...
chaco_region <- st_union(chaco_dpto, by_feature = FALSE, 
                         is_coverage = TRUE)|> 
  st_make_valid()
...
# SAVE FL FILE
fl_2005_2011_filtered <- fl_2005_2011 %>%
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")
...
# SAVE FL FILE
fl_2011_2013_filtered <- fl_2011_2013 %>%
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")
...
```{r}
# FC 2013 fc_2013_chaco 
# NF 2013 nf_2013_chaco 

# FC 2016
fc_2016_chaco <- st_intersection(chaco_region, fc_2016)

# NF 2016
nf_2016_chaco <- st_erase(chaco_region, fc_2016_chaco) 

# Forest Loss (FL) 2013 - 2016
fl_2013_2016 <- st_erase(nf_2016_chaco, nf_2013_chaco)

# SAVE FL FILE
fl_2013_2016_filtered <- fl_2013_2016 %>% # why this???
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")

# FL directory **** REMINDER ONLY RUN ONCE IT WILL CREATE DUPLICATE FILES AND FOLDERS *****
# fl_filepath <- path.expand("~/../../capstone/pyforest/data/forest_loss")
dir.create(file.path(fl_filepath, "13_16_forest_loss")) # mkdir
filepath_4 <- file.path(fl_filepath, "13_16_forest_loss", "13_16_forest_loss.shp") # file dir
write_sf(fl_2013_2016_filtered, filepath_4) # creates file
```

# 2016 - 2017 FL

```{r}
# FC 2016 fc_2016_chaco 
# NF 2016 nf_2016_chaco 

# FC 2017
fc_2017_chaco <- st_intersection(chaco_region, fc_2017)

# NF 2017 
nf_2017_chaco <- st_erase(chaco_region, fc_2017_chaco) 

# Forest Loss (FL) 2016 - 2017
fl_2016_2017 <- st_erase(nf_2017_chaco, nf_2016_chaco)

# SAVE FL FILE
fl_2016_2017_filtered <- fl_2016_2017 %>% 
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")

# FL directory **** REMINDER ONLY RUN ONCE IT WILL CREATE DUPLICATE FILES AND FOLDERS *****
# fl_filepath <- path.expand("~/../../capstone/pyforest/data/forest_loss")
dir.create(file.path(fl_filepath, "16_17_forest_loss")) # mkdir
filepath_5 <- file.path(fl_filepath, "16_17_forest_loss", "16_17_forest_loss.shp") # file dir
write_sf(fl_2016_2017_filtered, filepath_5) # creates file
```

# 2017 - 2018 FL

```{r}
# FC 2017 fc_2017_chaco 
# NF 2017 nf_2017_chaco 

# FC 2018
fc_2018_chaco <- st_intersection(chaco_region, fc_2018)

# NF 2018 
nf_2018_chaco <- st_erase(chaco_region, fc_2018_chaco) 

# Forest Loss (FL) 2017 - 2018
fl_2017_2018 <- st_erase(nf_2018_chaco, nf_2017_chaco)

# SAVE FL FILE
fl_2017_2018_filtered <- fl_2000_2005 %>% 
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")

# FL directory **** REMINDER ONLY RUN ONCE IT WILL CREATE DUPLICATE FILES AND FOLDERS *****
# fl_filepath <- path.expand("~/../../capstone/pyforest/data/forest_loss")
dir.create(file.path(fl_filepath, "17_18_forest_loss")) # mkdir
filepath_6 <- file.path(fl_filepath, "17_18_forest_loss", "17_18_forest_loss.shp") # file dir
write_sf(fl_2017_2018_filtered, filepath_6) # creates file
```

# 2018 - 2020 FL

```{r}
# FC 2018 fc_2018_chaco 
# NF 2018 nf_2018_chaco 

# FC 2020
fc_2020_chaco <- st_intersection(chaco_region, fc_2020)

# NF 2020 
nf_2020_chaco <- st_erase(chaco_region, fc_2020_chaco) 

# Forest Loss (FL) 2018 - 2020
fl_2018_2020 <- st_erase(nf_2020_chaco, nf_2018_chaco)

# SAVE FL FILE
fl_2018_2020_filtered <- fl_2000_2005 %>% 
  st_collection_extract() %>%
  st_cast("MULTIPOLYGON")

# FL directory **** REMINDER ONLY RUN ONCE IT WILL CREATE DUPLICATE FILES AND FOLDERS *****
# fl_filepath <- path.expand("~/../../capstone/pyforest/data/forest_loss")
dir.create(file.path(fl_filepath, "18_20_forest_loss")) # mkdir
filepath_7 <- file.path(fl_filepath, "18_20_forest_loss", "18_20_forest_loss.shp") # file dir
write_sf(fl_2018_2020_filtered, filepath_7) # creates file
```
